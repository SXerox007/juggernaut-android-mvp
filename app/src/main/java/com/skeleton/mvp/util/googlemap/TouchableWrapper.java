...
public final class TouchableWrapper extends FrameLayout {
    ...
    public TouchableWrapper(final Context context) {
        ...
        scaleGestureDetector = new ScaleGestureDetector(getContext(), new ScaleGestureDetector.OnScaleGestureListener() {
            ...
            public boolean onScale(final ScaleGestureDetector detector) {
                if (lastSpan == -1) {
                    ...
                    if (map != null) {
                        map.animateCamera(CameraUpdateFactory.zoomBy(getZoomValue(detector.getCurrentSpan(), lastSpan)), MIN_MILLISECONDS, null);
                    }
                    lastSpan = detector.getCurrentSpan();
                }
                return false;
        ...
        gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onDoubleTapEvent(final MotionEvent e) {
                disableScrolling();
                if (map != null) {
                    map.animateCamera(CameraUpdateFactory.zoomIn(), MAP_ZOOM_ANIM_DURATION, null);
                }
                return true;
            }
        });
     ...
     */
    public void initMap(final GoogleMap gMap) {
        this.map = gMap;
    }
